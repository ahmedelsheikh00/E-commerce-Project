...
import CategoriesSlider from '../Categorsslider/Categorsslider';
...
<header className='row  g-0 '>
  ...
  <Slider  {...settings}>   
   <img src={img3} alt="" className='w-100' height={450} />

    <img src={img1} alt="" className='w-100' height={450} />
     
      </Slider>

  </div>
  <div className='col-lg-3  d-lg-block d-none '>
    <img src={img5} alt="" className='w-100' height={225} />
    <img src={img2} alt="" className='w-100' height={225} />

  </div>
  <h4 className='mt-5 mb-4 categories'>shop Popular Categories</h4>
